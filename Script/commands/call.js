module.exports.config = {
 ...
 version: "1.0.0",
 hasPermssion: 0,
 credits: "—͟͟͞͞𝐎𝐇𝐈𝐃 ☢️_𖣘 -𝐁𝐎𝐓 ⚠️ 𝑪𝑶𝑴𝑴𝑼𝑵𝑰𝑻𝒀_ ☢️", //don't change my credit 
...
module.exports.run = async ({ api, event, args }) => {
 ...
 return api.sendMessage(`✅ —͟͟͞͞𝐎𝐇𝐈𝐃 ☢️_𖣘 -𝐁𝐎𝐓 কল বোম্বিং সম্পন্ন হয়েছে ${number} নম্বরে।`, event.threadID, event.messageID);
 } catch (error) {
